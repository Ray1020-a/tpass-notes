...
export default function DeniedPage() {
  return (
    <div className="rounded-2xl border-2 border-[oklch(0.21_0.01_264)] bg-[oklch(0.96_0.05_60)] p-8 shadow-[4px_4px_0_0_var(--color-foreground)]">
      <h1 className="text-2xl font-extrabold">權限不足</h1>
      <p className="mt-3">您目前沒有讀取此服務的權限，請改由合適的帳號登入。</p>
